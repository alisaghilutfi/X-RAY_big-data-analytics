...
xray_data['path_length'] = xray_data['full_path'].str.len()
xray_data = xray_data[xray_data['path_length']>16]
new_obs = len(xray_data)
print('Number of updated observations:',new_obs)
